...
public class AdapterListaProducto extends ArrayAdapter<Producto> {

    private ArrayList<Producto> items;

    public AdapterListaProducto(Context context, int textViewResourceId, ArrayList<Producto> items){
